  ...
  <div>
    ...
    <div className="content-container-body">
      ...
      <div className="text-container">
        ...
        <p>
          ThaiPrayers.com ได้รวบรวมบทสวดมนต์แปล พร้อมทั้งเสียงสวดมนต์
          แบบฉบับวัดหนองป่าพง เพื่อเป็นประโยชน์
          เพื่อเป็นเครื่องมืออำนวยความสะดวก แก่ผู้ที่สนใจต้องการสวดมนต์
          แก่ผู้ที่ศึกษาและปฏิบัติธรรมทุกๆท่าน
          สุดท้ายนี้ก็ขอ อนุโมทนาบุญกับทุกท่านด้วยเทอญ
        </p>
      </div>
    </div>
  </div>
